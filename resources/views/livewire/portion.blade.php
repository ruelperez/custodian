                ...
                <div>
                    ...
                    @else
                        <div style="width: 70%; margin-left: 15%; margin-top: 7%;">
                            ...
                            <div style="display: flex; margin-top: 1%;">
                                <div style=" cursor: pointer; display: flex; width: 50%; height: 100px; padding-top: 1%; padding-bottom: 1%; background-color: #6B8E23; color: white; margin-left: 25%;" wire:click="clickReport('par-report')">
                                    <div style="margin-left: 5%;">
                                        <img src="{{asset('image/pmr-report.png')}}" width="80">
                                    </div>
                                    <div style="margin-left: 8%; margin-top: 7%;">
