<div>
    ...
    <div class="input-group mb-1" style="width: 40%; margin-left: 30%; margin-top: 3%;">
        ...
        <span class="input-group-text" @if($display_table == "hide") wire:click="find" @endif id="basic-addon2" style="cursor: pointer;"><i class="fa-solid fa-magnifying-glass" style="font-size: 20px;"></i></span>
    </div>
