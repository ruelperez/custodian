<div style="display: flex;">
    <div style="margin-top: 2%;">
        ...
        <div style="background-color: #F5F5F5; margin-left: 2%;margin-top: 0.5%; width: 100%; border: solid lightslategray 1px">
            ...
            <span data-bs-toggle="modal" data-bs-target="#add_request_modal" title="Add Item" class="bi bi-plus-circle-fill" style="font-size: 30px; color: rgb(165, 42, 42);margin-left: 45%; cursor: pointer;">+</span>
    ...
    <div style="margin-top: 2%; margin-left: 0.5%;">
        ...
        <div style="background-color: #F5F5F5; margin-left: 2%;margin-top: 0.5%; width: 100%; border: solid lightslategray 1px">
            ...
            <span data-bs-toggle="modal" data-bs-target="#add_request_modal" title="Add Item" class="bi bi-plus-circle-fill" wire:loading.remove style="font-size: 30px; color: rgb(165, 42, 42);margin-left: 45%; cursor: pointer;">+</span>
                <table class="table table-hover" style="width: 100%; text-align: center" >
                    <thead>
                    <tr>
                        <th>
