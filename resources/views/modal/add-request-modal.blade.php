        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <form wire:submit.prevent="submit">
                    ...
                    <div class="mb-3" style="width: 70%; margin-left: 15%;">
                        <input type="text" class="form-control" placeholder="Purpose" wire:click="not_item_click" wire:model="purpose" >
                    </div>
                    @error('purpose') <span style="color: red">{{ $message }}</span> @enderror
                    <div class="mb-3" style="width: 70%; margin-left: 15%;">
                        <input type="text" class="form-control" placeholder="Requested by" wire:click="not_item_click" wire:model="requested_by" >
                    </div>
                    @error('requested_by') <span style="color: red">{{ $message }}</span> @enderror
                    <div class="mb-3" style="width: 70%; margin-left: 15%;">
                        <input type="text" class="form-control" placeholder="Approved by" wire:click="not_item_click" wire:model="approved_by" >
                    </div>
                    @error('approved_by') <span style="color: red">{{ $message }}</span> @enderror
                    <div class="mb-3" style="width: 70%; margin-left: 15%;">
                        <input type="text" class="form-control" placeholder="Designator" wire:click="not_item_click" wire:model="designator" >
                    </div>
